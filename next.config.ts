...
const contentSecurityPolicy = [
  ...
  "connect-src 'self' https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://www.google.com https://*.ingest.sentry.io https://api.telegram.org",
  "worker-src 'self'",
  "manifest-src 'self'",
